...
if (product.buildId !== '0.8.0-debug.001') throw new Error('Unexpected build');
const build = product.buildId, report = path.join(root, 'reports/development-2026-09-20');
...
for (const file of await files(report)) selection.push('reports/development-2026-09-20/' + file);
selection.sort();
const manifest = [];
