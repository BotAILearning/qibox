...
if (product.buildId !== '0.7.2-debug.001') throw new Error('Unexpected build');
const build = product.buildId, report = path.join(root, 'reports/development-2026-09-18');
...
for (const file of await files(report)) selection.push('reports/development-2026-09-18/' + file);
selection.sort();
const manifest = [];
