...
if (product.buildId !== '0.8.6-debug.003') throw new Error('Unexpected build: ' + product.buildId);
...
await writeFile(path.join(report, 'source-stage-parity-088.json'), JSON.stringify({ build, files: parity }, null, 2));
const selection = [];
